  ...
  return (
    <div className="relative w-full flex-1 flex items-center justify-center overflow-hidden py-16">
      ...
      <Card className="relative z-10 max-w-lg mx-auto p-8 sm:p-10 text-center flex flex-col items-center shadow-lifted">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900! mb-1">Thank you!</h1>
        ...
        <div className="w-full mt-6 pt-6 border-t border-gray-100 flex flex-col gap-3 text-left text-sm text-gray-600">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-accent-subtle text-accent-hover text-xs font-semibold shrink-0">1</span>
            Our team reviews your request
          </div>
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-accent-subtle text-accent-hover text-xs font-semibold shrink-0">2</span>
            We prepare a tailored quote
          </div>
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-accent-subtle text-accent-hover text-xs font-semibold shrink-0">3</span>
            You&apos;ll hear back from us by email
          </div>
        </div>

        <Link href="/" className={buttonClasses({ variant: 'primary', className: 'mt-7' })}>
          Back to shop
        </Link>
      </Card>
    </div>
