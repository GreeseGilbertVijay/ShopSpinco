    ...
    <div className="rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.12)]">
      ...
      <div className="flex items-center justify-center p-6 sm:p-8 lg:p-12 overflow-y-auto lg:overflow-visible">
        <div className="w-full max-w-md text-left">
          <h1 className="text-3xl sm:text-4xl font-bold text-black!">Log In</h1>
          <p className="text-black/60 mt-1 mb-6 sm:mb-8">Enter your credentials to access your account.</p>
          ...
          <p className="mt-4 text-sm text-black/70 text-center">
            ...
            <Link href="/register" className="text-[#f29a4e] font-medium no-underline hover:underline">
              Register
            </Link>
          </p>
        </div>
